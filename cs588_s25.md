...
| Topic                        | Reading                                                      |
| ---------------------------- | ------------------------------------------------------------ |
| Introduction                 | [how to read a paper](http://ccr.sigcomm.org/online/files/p83-keshavA.pdf) |
| Introduction to Cryptography | [Demystifying the Threat-Modelling Process](https://www.ida.liu.se/~TDDC90/literature/papers/torr.pdf), |
| Public Key Infrastructure    | [CT Log whitepaper](https://dl.acm.org/doi/abs/10.1145/2668152.2668154), [Auditing the CT log](https://arxiv.org/pdf/2203.01661) |
| Passwords                    | [Why aren't we using passkeys](https://www.blaseur.com/papers/fidoobstacles.pdf), [more on aPAKEs](https://blog.cryptographyengineering.com/2018/10/19/lets-talk-about-pake/) |
| E2EE messaging               | [Off the record messaging](https://otr.cypherpunks.ca/otr-wpes.pdf) [Asynchronous Key Ratcheting](https://signal.org/docs/specifications/doubleratchet/doubleratchet.pdf), [X3DH](https://signal.org/docs/specifications/x3dh/x3dh.pdf) |
| Anonymous communication      | [Onion Encryption](https://dl.acm.org/doi/pdf/10.1145/358549.358563), [The Tor Browser](https://css.csail.mit.edu/6.858/2022/readings/tor-design.pdf), [DC-Nets](https://www.cs.cornell.edu/people/egs/herbivore/dcnets.html) |
| PIR                          | [Write up](https://emilymstark.com/2021/04/28/the-fundamental-laws-of-private-information-retrieval.html)  , [paper](https://eprint.iacr.org/2019/1075.pdf), [Path ORAM](https://eprint.iacr.org/2013/280.pdf) |
| Confidential computing       | [Fully Homomorphic Encryption](https://eprint.iacr.org/2023/1402.pdf), [TEE](https://hal.science/hal-01246364v1/file/trustcom_2015_tee_what_it_is_what_it_is_not.pdf) |
| Consensus                    | [Practical BFT](https://css.csail.mit.edu/6.824/2014/papers/castro-practicalbft.pdf), [Nakamoto Consensus](https://decentralizedthoughts.github.io/2021-10-15-Nakamoto-Consensus/) |
